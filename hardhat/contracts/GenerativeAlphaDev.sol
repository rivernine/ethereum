    ...
    Ownable
{
    ...
    function verifyTest(NFTVoucher calldata voucher)
        external
        view
        returns (address)
    {
    ...
    function voucherTokenId(NFTVoucher calldata voucher)
        external
        view
        returns (uint256)
    {
    ...
    function voucherTokenURI(NFTVoucher calldata voucher)
        external
        view
        returns (string memory)
    {
        return voucher.tokenURI;
    }
